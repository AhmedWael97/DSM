                            ...
                            (e.toString = function () {
                                return this.map(function (e) {
                                    ...
                                    return (
                                        ...
                                        a && (i += "@layer".concat(e[5].length > 0 ? " ".concat(e[5]) : "", " {")),
                                        (i += t(e)),
                                        a && (i += "}"),
                                        e[2] && (i += "}"),
                                        e[4] && (i += "}"),
                            ...
                            (i = [{
                                            ...
                                            if (a) {
                                                ...
                                                this._loadStylesheets(
                                                        ((s = {}),
                                                            ...
                                                            (n = g(n)) in s ? Object.defineProperty(s, n, {
                                                                value: o,
                                                                enumerable: !0,
                                                                configurable: !0,
                                                                writable: !0
                                    ...
                                    value: function (t) {
                                        ...
                                        if (this._hasControls("headerType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                                            ...
                                            "fixed" === this.settings.headerType || "fixed-offcanvas" === this.settings.headerType ?
                                                a && i && (window.Helpers.menuPsScroll.destroy(), (i = new a(document.querySelector(".menu-inner"), {
                                                    suppressScrollX: !0,
                                                    wheelPropagation: !1
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        "" !== i || "" !== a || "" !== s || "" !== n || "" !== o || "" !== l || "" !== u ? this._showResetBtnNotification(!0) : this._showResetBtnNotification(!1),
                                            ...
                                            ((document.cookie = "style=; expires=Thu, 01 Jan 2000 00:00:00 UTC; path=/;"), (this.settings.style = -1 !== this.settings.styles.indexOf(a) ? a : this.settings.defaultStyle)),
